...
def app_descriptor_1_yaml():
  with open(os.path.join(test.__path__[0], "data/app_descriptor_1.yaml")) as f:
    return f.read() 

@pytest.fixture(scope="session")
def app_descriptor_2_yaml():
  with open(os.path.join(test.__path__[0], "data/app_descriptor_2.yaml")) as f:
    return f.read() 
...
def app_descriptor_compss_1_yaml():
  with open(os.path.join(test.__path__[0], "data/app_descriptor_compss_1.yaml")) as f:
    return f.read() 
  
@pytest.fixture(scope="session")
def app_descriptor_compss_2_yaml():
  with open(os.path.join(test.__path__[0], "data/app_descriptor_compss_2.yaml")) as f:
    return f.read() 
