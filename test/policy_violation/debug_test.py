...
def test_policy_debug(policy_cpu144_dict, policy_cpu144_alerts_dict, policy_cpu144_resolve_dict, mocker, test_http_client_mongo):
  ...
  test_http_client_mongo.post(f"polman/watcher/api/v1/test/violate/{p.id}/100")
  ...
  # 3. Send Resolve
  test_http_client_mongo.post(f"polman/watcher/api/v1/test/resolve/{p.id}")
